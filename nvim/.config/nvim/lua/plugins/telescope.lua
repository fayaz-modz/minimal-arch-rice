return {
  { 'nvim-telescope/telescope-ui-select.nvim' },
  {
    ...
    config = function()
      ...
      keymap('n', '<C-p>gp', builtin.live_grep, { desc = "Grep" })
      keymap('n', '<C-p>b', builtin.buffers, { desc = "Buffers" })
      keymap('n', '<C-p>h', builtin.help_tags, { desc = "Help" })
      keymap('n', '<C-p>gf', builtin.git_files, { desc = "Git files" })
      keymap('n', '<C-p>d', builtin.diagnostics, { desc = "Diagnostics" })
      keymap('n', '<C-p>cm', builtin.commands, { desc = "Commands" })
      ...
      keymap('n', '<C-p>gs', builtin.grep_string, { desc = "Word under cursor" })
